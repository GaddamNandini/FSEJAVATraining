...
public class TV {
	...
	void insertData(String B, String m, Integer s, Integer p, String c, String dt) {
	...
	void displayTV() {
		System.out.println(
				Brand + " " + ModelName + " " + Screensize + " " + price + " " + color + " " + DisplayType + " ");
	}
	...
	public static void main(String args[]) {
		...
		// +samsungFrame.Screensize+" "+samsungFrame.price+" "+samsungFrame.color+ " "+
		// samsungFrame.DisplayType+" ");
